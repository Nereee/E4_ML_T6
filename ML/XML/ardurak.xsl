...
<body>
    ...
    <header>
        <div id="image-text-container">
            <a href="index.html"><img src="../irudiak/logo.png" alt="logoa"></a>
            <h1>APA MUSIC</h1>
        </div>
        <div>
            <nav>
                <ul>
                    <li><a href="hasiera.html">Hasiera</a></li>
                    <li><a href="langileak.html">Langileak</a></li>
                    <li><a href="departamentuak.html">Departamentuak</a></li>
                </ul>
            </nav>
        </div>
    </header>
    ...
    <main>
        <h2>Ardurak</h2>
        <div class="">
            <xsl:for-each select="langileak/ardurak">
                <div class="employee">
                    <h3><xsl:value-of select="izena"/> <xsl:value-of select="abizena"/></h3>
